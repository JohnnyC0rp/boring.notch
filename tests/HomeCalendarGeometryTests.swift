...
enum HomeCalendarGeometryTests {
    static func main() {
        ...
        require(HomeCalendarGeometry.date(at: -1, in: days) == days.first!.visibleInterval.start, "Negative offsets must clamp to the window start")
        require(HomeCalendarGeometry.date(at: width + 1, in: days) == days.last!.visibleInterval.end,
    ...
    private static func verifyCroppedHours(calendar: Calendar) {
        ...
        for target in [date("2026-09-06T23:30:00Z"), date("2026-09-07T06:00:00Z"), date("2026-09-07T18:30:00Z"), date("2026-09-07T23:30:00Z")] {
            ...
            let center = HomeCalendarGeometry.date(at: offset + 157.5, in: empty)!
